...
int main(int argc, char **argv) {
    ...
    }
    {
        ...
        ASSERT(sizeof(vec) == 24, "Make this assertion pass.");
        {
            auto capacity = vec.capacity();
            vec.resize(16);
            ASSERT(vec.size() == 16, "Make this assertion pass.");
            ASSERT(vec.capacity() == capacity, "Make this assertion pass.");
        }
        {
            vec.reserve(256);
            ASSERT(vec.size() == 16, "Make this assertion pass.");
            ASSERT(vec.capacity() == 256, "Make this assertion pass.");
        }
        {
            vec.push_back('a');
            vec.push_back('b');
